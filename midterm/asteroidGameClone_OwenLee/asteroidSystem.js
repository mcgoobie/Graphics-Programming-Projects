class AsteroidSystem {
  ...
  spawn(){
    if (random(this.scaleDifficulty)<0.01){
      ...
      // scale difficulty to spawn asteroids more frequently
      if (this.scaleDifficulty > 0.3)
        this.scaleDifficulty = this.scaleDifficulty - 0.02;
    }
